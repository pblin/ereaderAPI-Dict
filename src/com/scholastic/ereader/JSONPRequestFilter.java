 ...
 * </p>
 * <p>To qualify for wrapping the request must be made to the <i>/restApp/*</i> path, and contain a query parameter call
 * <i>jsonp</> that defines the JSONP callback method to use with the response.
 * </p>
 * @author balunasj
 *
 */
...
public class JSONPRequestFilter implements Filter {
    ...
    private static final String CALLBACK_METHOD = "jsonp";
